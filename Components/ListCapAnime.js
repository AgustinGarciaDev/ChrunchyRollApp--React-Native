    ...
    <View style={styles.containerListAnime}>
      <TouchableOpacity
        ...
        <Text style={styles.textSeason}>
          {" "}
          S1-To your Eternity (Portuguese Dub)
        </Text>
      </TouchableOpacity>
      <Modal
        animationType="fade"
        ...
        <Modal
          ...
          <View style={styles.modalSincronization}>
            <ImageBackground
              ...
              source={{
                uri: "https://i1.wp.com/nosomosnonos.com/wp-content/uploads/2020/06/Rent-a-Girlfriend-1.jpg",
              }}
              resizeMode="cover">
              <LinearGradient
                start={{x: 0.5, y: 0.5}}
                ...
                <View style={styles.containerTitleModal}>
                  <TouchableOpacity
                    onPress={() =>
                      setModalSincronitation(!modalSincronitation)
                    }>
                    <Icon
                      style={{marginRight: 10, marginLeft: 10}}
                      name="times"
                ...
                <View style={{alignItems: "center"}}>
                  ...
                  <View>
                    ...
                    <Text style={{textAlign: "center", color: "white"}}>
                      Solos los miembros Mega Fan pueden
                    </Text>
                    <Text style={{textAlign: "center", color: "white"}}>
                      sicronizar videos para verlos sin conexion
                    </Text>
                  </View>
          ...
          <TouchableWithoutFeedback
            ...
            <View style={styles.modalOrder}>
              <View style={styles.containerModalOrder}>
                <Text style={{color: "#55565B", marginBottom: 40}}>
                  Ordenar por:
                </Text>
                <TouchableOpacity>
                  <Text
                    style={{color: "white", fontSize: 18, marginBottom: 40}}>
                    Más antiguo
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity>
                  <Text style={{color: "#FF6907", fontSize: 17}}>
                    Más nuevo
                  </Text>
                </TouchableOpacity>
              </View>
