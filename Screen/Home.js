    ...
    return (
      <View key={index} style={styles.slide}>
        <ImageBackground
          ...
          style={styles.imageCarrousel}></ImageBackground>
        <TouchableOpacity
          onPress={() => {
            props.navigation.navigate("Anime", {id: item._id});
          }}>
  ...
  return (
    <ScrollView style={styles.container}>
        ...
        <ImageBackground
          ...
          <LinearGradient
            ...
            <View style={styles.containerTextCover}>
              ...
              <Text style={styles.subTextCoverTitle}>
                {" "}
                Al prinicipio el "orbe" llego a la Tierra. Podia hacer dos
                cosas: tomar la forma de cualquier cosa con la que inter...
              </Text>
              <TouchableOpacity
      ...
      <BoxAnime
        ...
        img={
          "https://user-images.githubusercontent.com/66225450/125543230-7d120643-e3b2-4dca-9970-35f144c4eaab.png"
        }
        cover={
          "https://ramenparados.com/wp-content/uploads/2020/12/Cheat-Kusushi-no-Slow-Life-poster-300x426.jpg"
        }
      />
      <View>
        <FlatList
      ...
      <BoxAnime
        name={"Boruto"}
        img={
          "https://img1.ak.crunchyroll.com/i/spire4/d11aa2cec683c50999692fe7487031ba1625611358_main.png"
        }
        cover={
      ...
      <BoxAnime
        ...
        img={
          "https://estrenos.news/wp-content/uploads/2021/01/1611750945_1_That-Time-I-Got-Reincarnated-as-a-Slime-Temporada-2.jpg"
        }
        cover={
