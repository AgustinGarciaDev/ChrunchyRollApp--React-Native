                ...
                <View style={{ padding: 10 }}>
                    {
                        !visibleComment
                            ? <>
                                <View>
                                    ...
                                    <View style={styles.containerTitleAndIcon}>
                                        ...
                                        <Icon style={{ marginRight: 10, marginLeft: 10 }} name="ellipsis-v" size={20} color="white" />
                                    </View>
                                    <Text style={{ color: '#CFD0D2', fontSize: 16, marginBottom: 20, marginTop: 10 }}>{text}</Text>
                                </View>
                                <View>
                                    ...
                                    >
                                        <Icon style={{ marginRight: 3, marginLeft: 3 }} name="comment" size={30} color="#CFD0D2" />
                                        <Text style={{ color: 'white' }}>Comentarios   {numberComments}</Text>
                                    </TouchableOpacity>
                                    <View style={styles.separator}></View>
                                </View>
                                <View style={{ marginTop: 20, marginBottom: 20 }}>
                                    ...
                                    <View style={styles.containerCap}>
                                        <ImageBackground
                                            source={{ uri: 'https://img1.ak.crunchyroll.com/i/spire2-tmb/108a437e007b516fedde13427d2af32d1618825084_wide.jpg' }}
                                            resizeMode="cover"
                                        ...
                                        <View style={{ justifyContent: 'space-between', width: 220 }}>
                                            ...
                                            <View style={{ alignItems: 'flex-start', flexDirection: 'row', }}>
                                                <Icon style={{ marginLeft: 15, marginBottom: 10 }} name="comment" size={22} color="#CFD0D2" />
                            ...
                            : <Comments visibleComment={visibleComment} setVisibleComment={setVisibleComment} />
                    }
                </View>
            </ScrollView >
        </>
